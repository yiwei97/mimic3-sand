...
# [To Do] Don't use this for now @yiwei, I haven't understood fully what DeepSupervisionDataLoader
args.deep_supervision = False # [Temp]
...
sand_env.train(
    train_ds,
    eval_dataset=None,
    model_name='decompensation',
    num_epochs=num_epochs,
    batch_size=batch_size,
    save_frequency=10,
    num_workers=0,
    dataset_name='decompensation'
)
